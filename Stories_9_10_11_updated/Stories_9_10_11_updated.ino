...
void story11()
{
  ...
  stopBeforeLight();// keep calling findLight until 5cm before obstacle
  // then use sonar to stop before hitting light
}

void checkBrightness(){
    hard_left(255,255); 
    delay(250); //for 45 degrees
...
void findLight(){
  ...
  //take reading from centre sensor
